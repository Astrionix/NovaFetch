...
export async function getGenericMetadata(url: string, match: PlatformMatch) {
  ...
  const formats = isAudioOnly
    ...
    : [
        { id: 'v-1080p', label: '1080p Full HD', type: 'video', quality: '1080p', resolution: '1920x1080', extension: 'mp4', estimatedSizeMB: 98.0, fps: 60, bitrate: '12 Mbps', codec: 'H.264', badge: 'PRO QUALITY', isPopular: true },
